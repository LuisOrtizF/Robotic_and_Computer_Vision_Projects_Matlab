###########################################################################
## Makefile generated for MATLAB file/project 'dCP'. 
## 
## Makefile     : dCP_rtw.mk
## Generated on : Fri May 04 21:15:23 2018
## MATLAB Coder version: 3.4 (R2017b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/dCP.a
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/dCP.a
...
INCLUDES_BUILDINFO = -I$(START_DIR)/codegen/lib/dCP -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=dCP -DHAVESTDIO -DUSE_RTMODEL -DUNIX
...
SRCS = $(START_DIR)/codegen/lib/dCP/dCP.cpp $(START_DIR)/codegen/lib/dCP/dCP_emxutil.cpp $(START_DIR)/codegen/lib/dCP/dCP_emxAPI.cpp $(START_DIR)/codegen/lib/dCP/rt_nonfinite.cpp $(START_DIR)/codegen/lib/dCP/rtGetNaN.cpp $(START_DIR)/codegen/lib/dCP/rtGetInf.cpp
...
OBJS = dCP.o dCP_emxutil.o dCP_emxAPI.o rt_nonfinite.o rtGetNaN.o rtGetInf.o
...
%.o : $(START_DIR)/codegen/lib/dCP/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/codegen/lib/dCP/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
