...
void c_emxFreeStruct_vision_internal(c_vision_internal_calibration_c *pStruct)
{
...
void c_emxInitStruct_vision_internal(const emlrtStack *sp,
  ...
  boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->BoardCoords, 3, srcLocation, doPush);
  emxInit_real_T1(sp, &pStruct->BoardIdx, 2, srcLocation, doPush);
  emxInit_real32_T(sp, &pStruct->Points, 2, srcLocation, doPush);
}
...
void emxEnsureCapacity_boolean_T2(const emlrtStack *sp, emxArray_boolean_T
  *emxArray, int32_T oldNumel, const emlrtRTEInfo *srcLocation)
{
  int32_T newNumel;
  int32_T i;
...
void emxInit_boolean_T2(const emlrtStack *sp, emxArray_boolean_T **pEmxArray,
  int32_T numDimensions, const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxArray_boolean_T *emxArray;
  int32_T i;
...
/* End of code generation (dCP_emxutil.c) */
