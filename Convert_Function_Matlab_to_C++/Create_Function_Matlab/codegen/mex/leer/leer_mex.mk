START_DIR = C:\Users\Luisito\Desktop

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2016a
MAKEFILE = leer_mex.mk

include leer_mex.mki
...
SYS_INCLUDE += -I "$(START_DIR)\codegen\mex\leer"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\leer/%.c
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\leer/%.cu
	$(CC) $(CCFLAGS) "$<"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\leer/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
