###########################################################################
## Makefile generated for MATLAB file/project 'fce'. 
## 
## Makefile     : fce_rtw.mk
## Generated on : Wed Jan 25 10:38:22 2017
## MATLAB Coder version: 3.1 (R2016a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/fce.lib
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/fce.lib
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/codegen/lib/fce -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=fce -DHAVESTDIO -DUSE_RTMODEL
...
SRCS = $(START_DIR)/codegen/lib/fce/fce.cpp $(START_DIR)/codegen/lib/fce/rt_nonfinite.cpp $(START_DIR)/codegen/lib/fce/rtGetNaN.cpp $(START_DIR)/codegen/lib/fce/rtGetInf.cpp
...
OBJS = fce.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj
...
%.obj : $(START_DIR)/codegen/lib/fce/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/codegen/lib/fce/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
