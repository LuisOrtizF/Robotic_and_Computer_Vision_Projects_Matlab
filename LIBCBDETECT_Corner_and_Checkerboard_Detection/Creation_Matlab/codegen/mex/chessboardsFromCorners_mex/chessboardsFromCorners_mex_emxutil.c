...
void emxFreeMatrix_cell_wrap_0(cell_wrap_0 pMatrix[4])
{
  int32_T i;
  for (i = 0; i < 4; i++) {
...
void emxFreeMatrix_cell_wrap_01(cell_wrap_0 pMatrix[5])
{
  int32_T i;
  for (i = 0; i < 5; i++) {
    emxFreeStruct_cell_wrap_0(&pMatrix[i]);
...
void emxInitMatrix_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 pMatrix[4],
...
void emxInitMatrix_cell_wrap_01(const emlrtStack *sp, cell_wrap_0 pMatrix[5],
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  int32_T i;
  for (i = 0; i < 5; i++) {
...
/* End of code generation (chessboardsFromCorners_mex_emxutil.c) */
