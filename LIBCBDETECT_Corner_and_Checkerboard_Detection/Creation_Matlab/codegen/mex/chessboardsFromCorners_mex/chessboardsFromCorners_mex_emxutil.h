/*
 * chessboardsFromCorners_mex_emxutil.h
 *
 * Code generation for function 'chessboardsFromCorners_mex_emxutil'
 *
 */

#ifndef CHESSBOARDSFROMCORNERS_MEX_EMXUTIL_H
#define CHESSBOARDSFROMCORNERS_MEX_EMXUTIL_H
...
extern void emxFreeMatrix_cell_wrap_0(cell_wrap_0 pMatrix[4]);
extern void emxFreeMatrix_cell_wrap_01(cell_wrap_0 pMatrix[5]);
...
extern void emxInitMatrix_cell_wrap_0(const emlrtStack *sp, cell_wrap_0 pMatrix
  [4], const emlrtRTEInfo *srcLocation, boolean_T doPush);
extern void emxInitMatrix_cell_wrap_01(const emlrtStack *sp, cell_wrap_0
  pMatrix[5], const emlrtRTEInfo *srcLocation, boolean_T doPush);
...
/* End of code generation (chessboardsFromCorners_mex_emxutil.h) */
