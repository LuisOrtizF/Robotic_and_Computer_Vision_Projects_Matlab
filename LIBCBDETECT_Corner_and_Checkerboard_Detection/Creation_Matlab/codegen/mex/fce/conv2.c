...
void b_conv2(const real_T arg1[921600], const real_T arg2[9], real_T c[921600])
{
  int32_T j;
  int32_T lastColA;
  int32_T k;
...
void c_conv2(const real_T arg1[921600], const real_T arg2_data[], const int32_T
...
void conv2(const real_T arg1[921600], real_T c[921600])
{
  int32_T j;
  int32_T lastColA;
  int32_T k;
  ...
  int32_T firstRowA;
  int32_T b_i;
  static const int8_T iv1[9] = { -1, -1, -1, 0, 0, 0, 1, 1, 1 };
  ...
  for (j = 0; j < 3; j++) {
    ...
    for (k = (j < 1); k <= lastColA; k++) {
      ...
      for (i = 0; i < 3; i++) {
        ...
        xaxpy(b_i - firstRowA, iv1[iB], arg1, (b_c + firstRowA) + 1, c, iC);
        iB++;
        if (i >= 1) {
          iC++;
        }
