...
static emlrtRSInfo kb_emlrtRSI = { 47, "createCorrelationPatch",
...
static emlrtRSInfo lb_emlrtRSI = { 48, "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m"
};

static emlrtRSInfo mb_emlrtRSI = { 49, "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m"
};

static emlrtRSInfo nb_emlrtRSI = { 50, "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m"
};

static emlrtRTEInfo g_emlrtRTEI = { 2, 21, "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m"
};

static emlrtDCInfo emlrtDCI = { 9, 25, "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  1 };
...
static emlrtDCInfo c_emlrtDCI = { 9, 32, "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  1 };
...
static emlrtBCInfo c_emlrtBCI = { -1, -1, 41, 23, "template.b2",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo d_emlrtBCI = { -1, -1, 41, 25, "template.b2",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo e_emlrtBCI = { -1, -1, 39, 23, "template.b1",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo f_emlrtBCI = { -1, -1, 39, 25, "template.b1",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo g_emlrtBCI = { -1, -1, 37, 23, "template.a2",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo h_emlrtBCI = { -1, -1, 37, 25, "template.a2",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo i_emlrtBCI = { -1, -1, 35, 23, "template.a1",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };

static emlrtBCInfo j_emlrtBCI = { -1, -1, 35, 25, "template.a1",
  "createCorrelationPatch",
  "C:\\Users\\Luisito\\Documents\\MAESTRIA ING_MECATRONICA\\Tesis\\Codigos\\DeteccionCornersLargasDistancias\\v7\\createCorrelationPatch.m",
  0 };
  ...
  emxArray_real_T *template_b1, emxArray_real_T *template_b2)
{
  ...
  if (!(height >= 0.0)) {
    emlrtNonNegativeCheckR2012b(height, &b_emlrtDCI, sp);
  }
  ...
  if (!(width >= 0.0)) {
    emlrtNonNegativeCheckR2012b(width, &d_emlrtDCI, sp);
  }

  y = width;
  if (y != (int32_T)muDoubleScalarFloor(y)) {
    emlrtIntegerCheckR2012b(y, &c_emlrtDCI, sp);
  }
  ...
  while (u - 1 <= (int32_T)width - 1) {
    ...
    while (v - 1 <= (int32_T)height - 1) {
      ...
      if (covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 0, s1 <= -0.1) &&
          covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 1, s2 <= -0.1)) {
        ...
        if (!((v >= 1) && (v <= b_template_a1))) {
          emlrtDynamicBoundsCheckR2012b(v, 1, b_template_a1, &i_emlrtBCI, sp);
        }

        b_template_a1 = template_a1->size[1];
        if (!((u >= 1) && (u <= b_template_a1))) {
          emlrtDynamicBoundsCheckR2012b(u, 1, b_template_a1, &j_emlrtBCI, sp);
        }
        ...
        if (covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 2, s1 >= 0.1) &&
            covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 3, s2 >= 0.1)) {
          covrtLogMcdc(&emlrtCoverageInstance, 2U, 0U, 1, true);
          covrtLogIf(&emlrtCoverageInstance, 2U, 0U, 1, true);
          ...
          if (!((v >= 1) && (v <= b_template_a1))) {
            emlrtDynamicBoundsCheckR2012b(v, 1, b_template_a1, &g_emlrtBCI, sp);
          }

          b_template_a1 = template_a2->size[1];
          if (!((u >= 1) && (u <= b_template_a1))) {
            emlrtDynamicBoundsCheckR2012b(u, 1, b_template_a1, &h_emlrtBCI, sp);
          }

          template_a2->data[(v + template_a2->size[0] * (u - 1)) - 1] = y;
        } else {
          covrtLogMcdc(&emlrtCoverageInstance, 2U, 0U, 1, false);
          covrtLogIf(&emlrtCoverageInstance, 2U, 0U, 1, false);
          if (covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 4, s1 <= -0.1) &&
              covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 5, s2 >= 0.1)) {
            covrtLogMcdc(&emlrtCoverageInstance, 2U, 0U, 2, true);
            covrtLogIf(&emlrtCoverageInstance, 2U, 0U, 2, true);
            covrtLogBasicBlock(&emlrtCoverageInstance, 2U, 4);
            y = radius / 2.0;
            if (y > 0.0) {
              t = dist / y;
              y = muDoubleScalarExp(-0.5 * t * t) / (2.5066282746310002 * y);
            ...
            if (!((v >= 1) && (v <= b_template_a1))) {
              emlrtDynamicBoundsCheckR2012b(v, 1, b_template_a1, &e_emlrtBCI, sp);
            }

            b_template_a1 = template_b1->size[1];
            if (!((u >= 1) && (u <= b_template_a1))) {
              emlrtDynamicBoundsCheckR2012b(u, 1, b_template_a1, &f_emlrtBCI, sp);
            }

            template_b1->data[(v + template_b1->size[0] * (u - 1)) - 1] = y;
          } else {
            covrtLogMcdc(&emlrtCoverageInstance, 2U, 0U, 2, false);
            covrtLogIf(&emlrtCoverageInstance, 2U, 0U, 2, false);
            if (covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 6, s1 >= 0.1) &&
                covrtLogCond(&emlrtCoverageInstance, 2U, 0U, 7, s2 <= -0.1)) {
              covrtLogMcdc(&emlrtCoverageInstance, 2U, 0U, 3, true);
              covrtLogIf(&emlrtCoverageInstance, 2U, 0U, 3, true);
              covrtLogBasicBlock(&emlrtCoverageInstance, 2U, 5);
              y = radius / 2.0;
              if (y > 0.0) {
                t = dist / y;
                y = muDoubleScalarExp(-0.5 * t * t) / (2.5066282746310002 * y);
              ...
              if (!((v >= 1) && (v <= b_template_a1))) {
                emlrtDynamicBoundsCheckR2012b(v, 1, b_template_a1, &c_emlrtBCI,
                  sp);
              }

              b_template_a1 = template_b2->size[1];
              if (!((u >= 1) && (u <= b_template_a1))) {
                emlrtDynamicBoundsCheckR2012b(u, 1, b_template_a1, &d_emlrtBCI,
                  sp);
              }

              template_b2->data[(v + template_b2->size[0] * (u - 1)) - 1] = y;
            } else {
              covrtLogMcdc(&emlrtCoverageInstance, 2U, 0U, 3, false);
              covrtLogIf(&emlrtCoverageInstance, 2U, 0U, 3, false);
            }
          }
        }
      }
  ...
  covrtLogBasicBlock(&emlrtCoverageInstance, 2U, 6);
